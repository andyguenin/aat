...
class Instrument(object):
    ...
    def __init__(self,
        ...
        if hasattr(self, "_Instrument__expiration"):
            assert kwargs.get('expiration') is None or self.__expiration == kwargs.get("expiration")
        else:
            self.__expiration = kwargs.get("expiration")

        if hasattr(self, "_Instrument__price_increment"):
            assert kwargs.get('price_increment') is None or self.__price_increment == kwargs.get("price_increment")
        ...
        if hasattr(self, "_Instrument__unit_value"):
            assert kwargs.get('unit_value') is None or self.__unit_value == kwargs.get("unit_value")
